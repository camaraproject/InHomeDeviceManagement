...
Sandbox API Repository to describe, develop, document, and test the InHomeDeviceManagement Service API(s) within the Sub Project []().
...
Incubating API Repository to evolve and maintain the definitions and documentation of InHomeDeviceManagement Service API(s) within the Sub Project []()
...
* Working Group [wiki home page](https://lf-camaraproject.atlassian.net/wiki/x/AQCxGw) 
...
* Meetings are held virtually <!-- for new, independent Sandbox API repositories request a meeting link from the LF admin team or replace the information with the existing meeting information of the Sub Project -->
  ...
  * Minutes: Access [meeting minutes](https://lf-camaraproject.atlassian.net/wiki/x/AQCxGw) !! update this link to your minutes archive page using the "Share" link and delete the task
* Mailing List
